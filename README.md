...
- **カテゴリ分類**: 取引・板情報、注文・執行、市場制度・取引所、清算・決済、デリバティブ、システム関連、規制・コンプライアンス、フロント／ミドル／バックオフィス、為替取引（FX）、債券・マネーマーケット、クオンツ・プライシングモデルの各カテゴリに整理しています。
...
現時点で用語数は184語です。用語は今後も追加・修正されます。
